...
def get_sources(category):
        ...
        '''
        get_sources_url ='https://newsapi.org/v2/sources?category&apiKey=a7c82e01873d4300a2317a0bfd25f4c5'
...
def search_new(new_name):
    search_new_url = 'https://newsapi.org/v2/everything?q=bitcoin&from=2019-01-18&sortBy=publishedAt&apiKey=a7c82e01873d4300a2317a0bfd25f4c5?api_key={}&query={}'.format(api_key,new_name)
